...
public class Robot extends TimedRobot {
  ...
  static private int ENCODER_EDGES_PER_REV = 8192 / 4;
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(21, Sides.LEFT, false);

    CANSparkMax leftFollowerID20 = setupCANSparkMax(20, Sides.FOLLOWER, false);
    leftFollowerID20.follow(leftMotor, false);
        
    

    CANSparkMax rightMotor = setupCANSparkMax(10, Sides.RIGHT, true);
    CANSparkMax rightFollowerID11 = setupCANSparkMax(11, Sides.FOLLOWER, true);
    rightFollowerID11.follow(rightMotor, true);
